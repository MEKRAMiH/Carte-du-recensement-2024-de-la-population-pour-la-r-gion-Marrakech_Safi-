...
var style_Pointsdepuisunetable_2 = function(feature, resolution){
    ...
    if ("" !== null) {
        ...
        function rules_Pointsdepuisunetable_2(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
        ...
        image: new ol.style.Circle({radius: 3.4 + size,
            stroke: new ol.style.Stroke({color: 'rgba(231,6,10,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1.52}), fill: new ol.style.Fill({color: 'rgba(231,6,10,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
        ...
        var style = rules_Pointsdepuisunetable_2(feature, value);
        ;
