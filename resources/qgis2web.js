...
map.getView().fit([-1103187.161675, 3564268.010182, -770504.450464, 3856881.171390], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Carte du recensement 2024 de la population pour la région Marrakech_Safi (By MEKRAMI)</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (188 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Réalistion d\'une carte choroplèthe interactive basée sur la variation de la population entre les différentes provinces de la région de Marrakech_Safi selon le recensement du septembre 2024';
            }
